...
export class CustomerAlreadyExists extends Data.TaggedError(
...
export class ServiceAlreadyExists extends Data.TaggedError(
...
export class InvalidOrderTransition extends Data.TaggedError(
...
export class OrderValidationError extends Data.TaggedError(
        ...
        const create = (data: CreateOrderData) =>
          Effect.gen(function* () {
            ...
            const itemsWithPrices = yield* Effect.forEach(
              ...
              (item) =>
                Effect.gen(function* () {
                  const serviceOption = yield* serviceRepo.findById(
                    item.serviceId,
                  );
