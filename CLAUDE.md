...
This project is indexed by GitNexus as **laundry-app** (3804 symbols, 6130 relationships, 72 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
